...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4(0.,0.,0.314, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.,0.627,0.906, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4(0.471,0.467,0., 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.969,0.973,0.345, 3.92156886E-03);
                return;
            } 
        } 
    } 
