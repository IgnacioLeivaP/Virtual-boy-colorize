...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.976,0.91,0.878, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4(0.976,0.722,0.529, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.498,0.255,0., 3.92156886E-03);
                return;
            } else {
                FragColor = vec4(0.184,0.094,0., 3.92156886E-03);
                return;
            } 
        } 
    } 
