...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4(0.973,0.847,0.702, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4(0.471,0.749,0.467, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4(0.412,0.529,0.247, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4(0.353,0.216,0.129, 3.92156886E-03);
                return;
            } 
        } 
    } 
