...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4(0.851,0.91,0.973, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4(0.882,0.533,0.31, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4(0.659,0.,0., 3.92156886E-03);
                return;
            } else {
                FragColor = vec4(0.,0.243,0.063, 3.92156886E-03);
                return;
            } 
        } 
    } 
