...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4(0.973,0.973,0.651, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4(0.761,0.498,0.282, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.98,0.,0., 3.92156886E-03);
                return;
            } else {
                FragColor = vec4(0.314,0.098,0., 3.92156886E-03);
                return;
            } 
        } 
    } 
