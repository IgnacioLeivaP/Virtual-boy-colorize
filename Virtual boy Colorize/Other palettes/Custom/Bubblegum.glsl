...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4(0.78,0.733,0.702, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4(0.808,0.388,0.553, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4(0.008,0.455,0.537, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4(0.145,0.133,0.008, 3.92156886E-03);
                return;
            } 
        } 
    } 
