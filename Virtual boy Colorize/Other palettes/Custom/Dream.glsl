...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.816,0.757,0.451, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4(0.161,0.694,0.659, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4(0.788,0.09,0.404, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4(0.204,0.043,0.337, 3.92156886E-03);
                return;
            } 
        } 
    } 
