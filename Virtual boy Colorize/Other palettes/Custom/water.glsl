...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4(0.125,0.843,0.78, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4(0.137,0.624,0.871, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4(0.145,0.369,0.765, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4(0.082,0.2,0.392, 3.92156886E-03);
                return;
            } 
        } 
    } 
