...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4(0.525,0.773,0.773, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4(0.349,0.514,0.71, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4(0.329,0.267,0.651, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4(0.259,0.082,0.333, 3.92156886E-03);
                return;
            } 
        } 
    } 
