...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.776,0.792,0.647, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.549,0.573,0.42, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4(0.29,0.318,0.22, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4(0.09,0.09,0.09, 3.92156886E-03);
                return;
            } 
        } 
    } 
