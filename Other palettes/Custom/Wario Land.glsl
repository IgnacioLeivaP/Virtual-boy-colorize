...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.886,0.859,0.353, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4(0.573,0.227,0.635, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.,0.098,0.682, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.008,0.004,0.024, 3.92156886E-03);
                return;
            } 
        } 
    } 
