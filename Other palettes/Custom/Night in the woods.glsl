...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4(0.773,0.451,0.341, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4(0.557,0.18,0.302, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.329,0.086,0.325, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.059,0.024,0.165, 3.92156886E-03);
                return;
            } 
        } 
    } 
