...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.161, 0.251, 0.22, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.22, 0.349, 0.29, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.353, 0.475, 0.259, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.482, 0.51, 0.063, 3.92156886E-03);
                return;
            } 
        } 
    } 
