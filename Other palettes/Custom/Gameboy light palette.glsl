...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4(0.,0.698,0.518, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4(0.,0.604,0.451, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4(0.,0.412,0.29, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4(0.,0.314,0.22, 3.92156886E-03);
                return;
            } 
        } 
    } 
