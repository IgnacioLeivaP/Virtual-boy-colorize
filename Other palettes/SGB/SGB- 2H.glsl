...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.988, 0.988, 0.988, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.718, 0.718, 0.718, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.431, 0.431, 0.431, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0., 0., 0., 3.92156886E-03);
                return;
            } 
        } 
    } 
