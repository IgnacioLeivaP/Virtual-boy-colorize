...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 1., 0.796, 0.639, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.325, 0.761, 0.78, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.961, 0.357, 0.157, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.239, 0.22, 0.443, 3.92156886E-03);
                return;
            } 
        } 
    } 
