...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.871, 0.976, 0.69, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.859, 0.663, 0.439, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0., 0.812, 0., 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0., 0.012, 0.031, 3.92156886E-03);
                return;
            } 
        } 
    } 
