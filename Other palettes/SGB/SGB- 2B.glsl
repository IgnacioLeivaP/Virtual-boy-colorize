...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.98, 0.98, 0.925, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.902, 0.922, 0.2, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.965, 0.188, 0., 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.271, 0.012, 0.388, 3.92156886E-03);
                return;
            } 
        } 
    } 
