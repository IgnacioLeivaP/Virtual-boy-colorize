...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.902, 0.784, 0.6, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.773, 0.525, 0.322, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.169, 0.451, 0.012, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0. ,0. ,0.055, 3.92156886E-03);
                return;
            } 
        } 
    } 
