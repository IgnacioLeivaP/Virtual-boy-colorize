...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.914, 0.859, 0.831, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.918, 0.651, 0.396, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.216, 0.498, 0.2, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.086, 0.039, 0.027, 3.92156886E-03);
                return;
            } 
        } 
    } 
