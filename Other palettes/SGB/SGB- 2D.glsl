...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.957, 1., 0.69, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.016, 0.973, 0.125, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.937, 0.196, 0., 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.039, 0., 0.275, 3.92156886E-03);
                return;
            } 
        } 
    } 
