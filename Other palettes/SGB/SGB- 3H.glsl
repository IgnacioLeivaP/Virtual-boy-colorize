...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.898, 0.984, 0.702, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.498, 0.792, 0.243, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.275, 0.537, 0.169, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.008, 0.098, 0., 3.92156886E-03);
                return;
            } 
        } 
    } 
