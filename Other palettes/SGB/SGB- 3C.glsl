...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.863, 0.655, 0.808, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.969, 1., 0.522, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.008, 0.702, 1., 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.106, 0.137, 0.373, 3.92156886E-03);
                return;
            } 
        } 
    } 
