...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.365, 0.745, 0.224, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.863, 0.318, 0.271, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.902, 0.702, 0.541, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.012, 0.098, 0., 3.92156886E-03);
                return;
            } 
        } 
    } 
