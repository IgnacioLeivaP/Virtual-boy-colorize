...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.941, 0.859, 0.745, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.843, 0.537, 0.259, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.035, 0.298, 0., 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.008, 0.071, 0.055, 3.92156886E-03);
                return;
            } 
        } 
    } 
