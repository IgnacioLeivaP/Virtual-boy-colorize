...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.722, 0.851, 0.039, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.655, 0.145, 0.282, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.141, 0.078, 0.008, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.016, 0.506, 0.4, 3.92156886E-03);
                return;
            } 
        } 
    } 
