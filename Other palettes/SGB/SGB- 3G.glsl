...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.38, 0.827, 0.322, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.941, 0.941, 0.933, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.776, 0.169, 0.1731, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.18, 0.024, 0., 3.92156886E-03);
                return;
            } 
        } 
    } 
