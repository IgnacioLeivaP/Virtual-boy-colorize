...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.941, 0.98, 0.773, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.839, 0.671, 0.396, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.651, 0.49, 0.125, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.337, 0.263, 0.498, 3.92156886E-03);
                return;
            } 
        } 
    } 
