...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.824, 0.933, 0.867, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.941, 0.588, 0.376, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.627, 0.012, 0., 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.094, 0., 0., 3.92156886E-03);
                return;
            } 
        } 
    } 
