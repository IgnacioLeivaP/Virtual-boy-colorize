...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.749, 0.776, 0.788, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.812, 0.494, 0.835, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.463, 0.02, 0.671, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.263, 0., 0., 3.92156886E-03);
                return;
            } 
        } 
    } 
