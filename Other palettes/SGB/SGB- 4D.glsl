...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.957, 0.945, 0.698, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.486, 0.804, 0.784, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.271, 0.408, 0.455, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.027, 0.133, 0.314, 3.92156886E-03);
                return;
            } 
        } 
    } 
