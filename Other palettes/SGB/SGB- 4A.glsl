...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.906, 0.702, 0.4, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.482, 0.663, 0.98, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.82, 0.004, 0.788, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0., 0.031, 0.49, 3.92156886E-03);
                return;
            } 
        } 
    } 
