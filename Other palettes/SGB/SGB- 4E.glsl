...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.933, 0.835, 0.643, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.859, 0.663, 0.443, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.498, 0.337, 0.58, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0., 0.137, 0.204, 3.92156886E-03);
                return;
            } 
        } 
    } 
