...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.941, 0.863, 0.824, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.82, 0.631, 0.816, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.608, 0.635, 0.843, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.043, 0., 0.027, 3.92156886E-03);
                return;
            } 
        } 
    } 
