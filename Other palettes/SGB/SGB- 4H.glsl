...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.922, 0.925, 0.749, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.745, 0.792, 0.373, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.502, 0.518, 0.278, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.247, 0.314, 0.137, 3.92156886E-03);
                return;
            } 
        } 
    } 
