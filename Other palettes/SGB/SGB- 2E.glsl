...
void main()
{
    ...
    if (_texColor.x >= 8.82352948E-01) { 
        FragColor = vec4( 0.898, 0.745, 0.49, 3.92156886E-03);
        return;
    } else {
        if (_texColor.x >= 6.27451003E-01) { 
            FragColor = vec4( 0.565, 0.667, 0.839, 3.92156886E-03);
            return;
        } else {
            if (_texColor.x >= 3.72549027E-01) { 
                FragColor = vec4( 0.133, 0.071, 0.318, 3.92156886E-03);
                return;
            } else {
                FragColor = vec4( 0.047, 0.016, 0.078, 3.92156886E-03);
                return;
            } 
        } 
    } 
